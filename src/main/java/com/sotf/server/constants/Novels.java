...
public enum Novels {
    ...
    HOC(new Novel("HoC", "House of Chains", 4,
            ...
            new Book(2, "Cold Iron", 5, 11),
            new Book(3, "Something Breathes", 12, 17),
            new Book(4, "House of Chains", 18, 26),
            Book.EPILOGUE
    )),
    MT(new Novel("MT", "Midnight Tides", 5,
            ...
            new Book(3, "All That Lies Unseen", 12, 19),
            new Book(4, "Midnight Tides", 20, 25),
            Book.EPILOGUE
    )),
